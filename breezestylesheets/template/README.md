...
This is the default template and icons, included in every generated stylesheet.
...
```json
{
    ...
    "SP_MediaSkipBackward": "skip_backward.svg",
    "SP_MediaSkipForward": "skip_forward.svg",
