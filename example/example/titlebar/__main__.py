...
from example.titlebar import ARGS, UNKNOWN, USE_WAYLAND_FRAME, FramelessWindow, Qt, Window
...
def main():
    ...
    app, window = Qt.create_application(ARGS, UNKNOWN, window_class=window_class)
